      ...
      <div className="mx-auto max-w-3xl px-4 py-10">
        ...
        <section className="mt-8 space-y-6 text-[15px] leading-8 text-slate-300">
          ...
          <div>
            ...
            <p>تقدر تطلب تصدير بياناتك أو حذف حسابك نهائياً في أي وقت عبر: <a className="text-[#a3e635] underline" href="mailto:abdalahana555@gmail.com">abdalahana555@gmail.com</a> — وسيتم الحذف خلال 7 أيام.</p>
          </div>
          <div>
